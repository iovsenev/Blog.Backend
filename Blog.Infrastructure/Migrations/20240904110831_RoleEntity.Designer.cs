...
namespace Blog.Infrastructure.Migrations
{
    ...
    [Migration("20240904110831_RoleEntity")]
            ...
            modelBuilder.Entity("Blog.Domain.Entity.Write.UserEntity", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Address", "Blog.Domain.Entity.Write.UserEntity.Address#AddressValue", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasIndex("RoleName")
                        .HasDatabaseName("ix_users_role_name");
            ...
            modelBuilder.Entity("Blog.Domain.Entity.Write.UserEntity", b =>
                {
                    b.HasOne("Blog.Domain.Entity.Write.RoleEntity", "Role")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_users_roles_role_name");
